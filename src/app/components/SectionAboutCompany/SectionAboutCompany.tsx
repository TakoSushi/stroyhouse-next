          ...
          >
            ...
            >
              <div
                ...
                data-src="/_next/static/media/aboutCompanyGallary1.e2b7d11f.jpg"
                /* В data-thumb-src указываем путь до малоразмерной картинки, которая будет отображаться в качестве превью  */
                data-thumb-src="/_next/static/media/aboutCompanyGallary1.e2b7d11f.jpg"
              >
                <Image
              ...
              <div
                className="f-carousel__slide"
                data-fancybox="gallery"
                data-src="/_next/static/media/aboutCompanyGallary2.8ab0929f.jpg"
                data-thumb-src="/_next/static/media/aboutCompanyGallary2.8ab0929f.jpg"
              >
                <Image
                  alt=""
                  src={images[1]}
              ...
              <div
                className="f-carousel__slide"
                data-fancybox="gallery"
                data-src="/_next/static/media/aboutCompanyGallary3.404a4959.jpg"
                data-thumb-src="/_next/static/media/aboutCompanyGallary3.404a4959.jpg"
              >
                <Image
                  alt=""
                  src={images[2]}
              ...
              <div
                className="f-carousel__slide"
                data-fancybox="gallery"
                data-src="/_next/static/media/aboutCompanyGallary4.81ccec50.jpg"
                data-thumb-src="/_next/static/media/aboutCompanyGallary4.81ccec50.jpg"
              >
                <Image
                  alt=""
                  src={images[3]}
              ...
              <div
                className="f-carousel__slide"
                data-fancybox="gallery"
                data-src="/_next/static/media/aboutCompanyGallary5.b91bd1e4.jpg"
                data-thumb-src="/_next/static/media/aboutCompanyGallary5.b91bd1e4.jpg"
              >
                <Image
                  alt=""
                  src={images[4]}
